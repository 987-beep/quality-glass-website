...
const SERVICES = [
  { key: "frame", en: "Photo Framing", hi: "फोटो फ़्रेमिंग", descEn: "Any size, any photo. Black, golden or wooden mouldings with clear or non-reflective glass and elegant mats.", descHi: "किसी भी साइज़, किसी भी फोटो की। सुनहरी, लकड़ी या काली माउल्डिंग, साफ़ या नॉन-रिफ्लेक्टिव काँच और सुंदर मैट।", price: "from ₹399", link: "/shop" },
  ...
  { key: "print", en: "Photo Printing", hi: "फोटो प्रिंटिंग", descEn: "Rich-colour glossy, matte and canvas prints — A5, A4, 12×18 and more, printed and framed in one order.", descHi: "गहरे रंगों में ग्लॉसी, मैट और कैनवास प्रिंट — A5, A4, 12×18 और बहुत कुछ।", price: "from ₹99", link: "/shop" },
