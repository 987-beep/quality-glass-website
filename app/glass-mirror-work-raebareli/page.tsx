...
export const metadata: Metadata = {
  title: "Glass & Mirror Work in Raebareli | Cutting, Table Tops, Sheets — Quality Framing Emporium",
  description:
  ...
  openGraph: {
    title: "Glass & Mirror Work in Raebareli | Quality Framing Emporium",
...
export default function GlassMirrorRaebareli() {
  return (
    <LocalLanding
      ...
      intro={[
        "Glass work is unforgiving — one millimetre wrong and the sheet is waste. That is why Raebareli has trusted Quality Framing Emporium for clean, accurate cutting since 2018: window panes, table tops, shelf glass, mirrors and replacement framing glass, all cut right here at the shop.",
      ...
      faqs={[
        { q: "Where can I get glass cut in Raebareli?", a: "Quality Framing Emporium & Photo Framing Center near Hotel Ganesh, PNT Colony (Belliganj Malik Mau Road) cuts window glass, mirror, shelf and table-top glass to size daily, 10 AM – 9 PM. WhatsApp your size to +91 83031 08051 for an instant quote." },
